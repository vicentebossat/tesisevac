...
def dist_to_fire(G, fire_poly):
    ...
    gs_nodes = ox.graph_to_gdfs(G,nodes = True,edges = False, node_geometry = True)[['geometry']]
    gs_edges = ox.graph_to_gdfs(G,nodes = False, edges = True)[['geometry']]
